...
// 提币限额
const listPageWithdrawPermission = function (data, success, error) {
    api.post(`/api/bm/account/transfer/listPageWithdrawPermission/${data.pageSize}/${data.page}`, data, (res) => {
        if (res.rst === 1) {
            success && success(res.data, res.total);
        } else {
            error && error(res.msg);
...
finance.listPageWithdrawPermission = listPageWithdrawPermission;

// 更新提币限额
const updateWithdrawPermission = function (data, success, error) {
    api.get(`/api/bm/account/transfer/updateWithdrawPermission`, data, (res) => {
        if (res.rst === 1) {
...
finance.updateWithdrawPermission = updateWithdrawPermission;

// 添加提币限额
const insertWithdrawPermission = function (data, success, error) {
    api.get(`/api/bm/account/transfer/insertWithdrawPermission`, data, (res) => {
        if (res.rst === 1) {
            success && success(res.msg);
        } else {
            error && error(res.msg);
...
finance.insertWithdrawPermission = insertWithdrawPermission;

// 删除提币限额
const deleteWithdrawPermission = function (data, success, error) {
    api.get(`/api/bm/account/transfer/deleteWithdrawPermission`, data, (res) => {
        if (res.rst === 1) {
            success && success(res.msg);
        } else {
            error && error(res.msg);
...
finance.deleteWithdrawPermission = deleteWithdrawPermission;
