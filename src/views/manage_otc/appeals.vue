  ...
  data () {
    return {
      ...
      columns1: [
        ...
        {title: '申诉人姓名', key: 'appealUserRealName', render:(h, params) => {return h('span',  params.row.appealUserRealName?params.row.appealUserRealName:'-')}},
        {title: '申诉人账号', key: 'appealUsername', render:(h, params) => {return h('span',  params.row.appealUsername?params.row.appealUsername:'-')}},
        {title: '被申诉人姓名', key: 'oppositeUserRealName', render:(h, params) => {return h('span',  params.row.oppositeUserRealName?params.row.oppositeUserRealName:'-')}},
        {title: '被申诉人账号', key: 'oppositeUsername', render:(h, params) => {return h('span',  params.row.oppositeUsername?params.row.oppositeUsername:'-')}},
        ...
        {title: '申诉内容', key: 'description', render:(h, params) => {return h('span',  params.row.description?params.row.description:'-')}},
        {title: '状态', key: 'state',
