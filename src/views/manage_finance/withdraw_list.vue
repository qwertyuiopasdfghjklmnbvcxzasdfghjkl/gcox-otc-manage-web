    ...
    <div style="width:2500px;">
        <Card>
            ...
            <Row style="margin-bottom: 20px;">
                ...
                <Col span="2">
                    <DatePicker type="date" v-model="date" :placeholder="$t('common.kssj')" format="yyyy-MM-dd"
                                style="width: 150px"></DatePicker>
                    <!-- <DatePicker v-model="formItem.date" format="yyyy-MM-dd" type="daterange" placement="bottom-end" style="width: 200px"></DatePicker> -->
                </Col>
                <Col span="2">
                    <DatePicker type="date" v-model="date1" :placeholder="$t('common.jssj')" format="yyyy-MM-dd"
                                style="width: 150px"></DatePicker>
                    <!-- <DatePicker v-model="formItem.date" format="yyyy-MM-dd" type="daterange" placement="bottom-end" style="width: 200px"></DatePicker> -->
                </Col>
